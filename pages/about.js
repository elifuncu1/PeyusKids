          ...
          <div className="row">
            <div className="ol-xl-7 col-lg-7 col-md-12">
              <div className="wrap-img ps-re">
                <img
                  src="assets/imgs/background/bg-aboutus-2.png"
                  alt=""
                  className="bg1-about"
                />
                  ...
                  >
                    <SwiperSlide>
                      ...
                      >
                        <div className="box-feature">
                          <img
                            src="assets/imgs/common/sc-employee-1.jpg"
                            alt="img"
                          />
                        </div>
                    ...
                    <SwiperSlide>
                      ...
                      >
                        <div className="box-feature">
                          <img
                            src="assets/imgs/common/sc-employee-2.jpg"
                            alt="img"
                          />
                        </div>
                    ...
                    <SwiperSlide>
                      ...
                      >
                        <div className="box-feature">
                          <img
                            src="assets/imgs/common/sc-employee-3.jpg"
                            alt="img"
                          />
                        </div>
                    ...
                    <SwiperSlide>
                      ...
                      >
                        <div className="box-feature">
                          <img
                            src="assets/imgs/common/sc-employee-4.jpg"
                            alt="img"
                          />
                        </div>
