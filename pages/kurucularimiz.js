...
const Teacher = () => {
  return (
    <Layout bodyClass={"teacher"}>
      <PageBanner pageName={"Kurucularımız"} />
              ...
              <h3 className="name" style={{ textAlign: "left" }}>Pelin Elhüseyni</h3>
                ...
                <div className="experience m-b38">
                  ...
                  <p>2022 yılında Bahçeşehir Üniversitesi Çocuk Gelişimi bölümünden onur derecesiyle mezun olmuştur. Üniversite yılları boyunca çeşitli anaokullarında ve rehabilitasyon merkezlerinde staj yaparak özel gereksinimli çocuklarla da çalışmıştır. Yaptığı stajlar, onun bu alandaki uzmanlığını pekiştirmiştir.
                    ...
                    Kurucuları arasında yer aldığı Peyus Kids&apos;te, çocukların gelişim değerlendirmelerini düzenli olarak takip ediyor, oyun atölyeleri düzenliyor, gelişimsel oyun gruplarını planlıyor ve her çocuğun ihtiyaçlarına yönelik bireyselleştirilmiş çalışmalar yapmaktadır. Çocukların potansiyellerini en üst düzeye çıkarmalarına destek olmayı amaçlamaktadır. Bununla beraber, oyun ve öğrenmeyi bir araya getiren çalışmalarıyla çocukların hem gelişimlerine hem de mutluluklarına katkı sağlamayı hedeflemektedir.
                  </p>
