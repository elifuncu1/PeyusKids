            ...
            <div className="col-12">
              <div className="title-heading st-2">
                <div className="sub-heading clr-pri-1 f-mulish">
                  <LeftArrowWhite />
                  <span className="inner-sub st-1">Neden Bizi Seçmelisiniz</span>
                  <RightArrowWhite />
                </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-5 col-sm-5">
              ...
              >
                ...
                <h4 className="title" style={{ fontSize: "24px", lineHeight: "1.2" }}>
                  ...
                  <p className="wrap f-mulish">
                  Çift dilli oyun grupları, çocukların iki dilde iletişim becerilerini etkileşimli oyunlarla geliştirdiği etkinliklerdir.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-3 col-md-5 col-sm-5">
              ...
              >
                ...
                <h4 className="title" style={{ fontSize: "24px", lineHeight: "1.2" }}>
                  ...
                  <p className="wrap f-mulish">
                  Çocukların fiziksel, zihinsel, duygusal ve sosyal gelişimini desteklemek için ailelere uzman rehberliği sunar.
                  </p>
                </div>
              </div>
            </div>
